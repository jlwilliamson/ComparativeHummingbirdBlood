...
date: "11/09/2020; Last Updated: 1/23/22"
output:
  md_document:
...
Note that elements of this script function as a notebook/codebook to document analyses that we didn't end up using in our paper (e.g., all transformation of wing loading data); see model structure and notes for information about what was/wasn't included in final paper analyses. 
...
# Nice n clunky n simple way of doing this: split df by sex, calculate mean masses per sex, and rbind back together 
...
# But since we didn't end up using wing loading data in within and among specides models, this ultimately doesn't matter!
...
**Conclusion:** Even after removing sampling outliers (species with <3 individuals sampled), there is no phylogenetic signal in our data. This is confirmed visually w/ contmaps and with estimates of Pagel's lamda and Blomberg's K. 
...
# elevation and elev_position are highly correlated (0.87)
...
These data are presented in SI Appendix Table S2. 
```{r}
# Parameter names 
...
TableS3_IndividualLevelSummaryValues <- cbind(col1, col2, col3, col4, col5, col6); table
colnames(TableS3_IndividualLevelSummaryValues) <- c("Parameter", "Mean", "Standard Deviation", "Min", "Max", "Coefficient of Variation")
# some weird character/string formatting going on, but I got the values I want for wrangling into Word format

# write.csv(TableS3_IndividualLevelSummaryValues, "TableS3_Individual-LevelSummaryValues.csv")
  # This file is called Table S3, but note that it became TAble S2 in paper
```
...
load("hb.m4_FullModel_SpeciesREOnly.RData") 
load("hb.m1_Intercept-Only.Rdata") 
...
save(hb.m4.c, file="hb.m4.c_TopModel_CladeREAdded.RData") # save model
#load("hb.m4.c_TopModel_CladeREAdded.RData") 
...
save(hb.m4.ce, file="hb.m4.ce_TopModel_CladeElevInteraction.RData") # save model
...
In a simple linear regression with no interactions, each coefficient says how much the average outcome,  
μ, changes when the predictor changes by one unit. And since all of the parameters have independent influences on the outcome, there’s no trouble in interpreting each parameter separately. Each slope parameter gives us a direct measure of each predictor variable’s influence.Interaction models ruin this paradise. (p. 220)
...
save(hb.elevclade, file="hb.elevclade_SimpleElevCladeModel.RData") # save model
#load("hb.elevclade_SimpleElevCladeModel.RData") 
...
save(hb.clade, file="hb.clade_SimpleCladeModel.RData") # save model
#load("hb.clade_SimpleElevCladeModel.RData") 
...
save(hct.m4.c, file="hct.m4.c_TopModel_CladeREAdded.RData") # save model
#load("hct.m4.c_TopModel_CladeREAdded.RData") 
...
save(hct.m4.ce, file="hct.m4.ce_TopModel_CladeElevInteraction.RData") # save model
#load("hct.m4.ce_TopModel_CladeElevInteraction.RData") 
...
save(trbc.m4.c, file="trbc.m4.c_TopModel_CladeREAdded.RData") # save model
#load("trbc.m4.c_TopModel_CladeREAdded.RData") 
...
save(trbc.m4.ce, file="trbc.m4.ce_TopModel_CladeElevInteraction.RData") # save model
#load("trbc.m4.ce_TopModel_CladeElevInteraction.RData") 
...
save(mcv.m6.c, file="mcv.m6.c_TopModel_CladeREAdded.RData") # save model
#load("mcv.m6.c_TopModel_CladeREAdded.RData") 
...
save(mcv.m6.ce, file="mcv.m6.ce_TopModel_CladeElevInteraction.RData") # save model
#load("mcv.m6.ce_TopModel_CladeElevInteraction.RData") 
...
save(mch.m6.c, file="mch.m6.c_TopModel_CladeREAdded.RData") # save model
#load("mch.m6.c_TopModel_CladeREAdded.RData") 
...
save(mch.m6.ce, file="mch.m6.ce_TopModel_CladeElevInteraction.RData") # save model
#load("mch.m6.ce_TopModel_CladeElevInteraction.RData") 
...
save(mchc.m6.c, file="mchc.m6.c_TopModel_CladeREAdded.RData") # save model
#load("mchc.m6.c_TopModel_CladeREAdded.RData") 
...
save(mchc.m6.ce, file="mchc.m6.ce_TopModel_CladeElevInteraction.RData") # save model
#load("mchc.m6.ce_TopModel_CladeElevInteraction.RData") 
