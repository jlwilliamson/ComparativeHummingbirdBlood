...
trbc.m3 <- brm(
 ...
 # data2 = list(A = A), # Phylogeny
  ...
  sample_prior = TRUE # default priors 
  # prior = c(
  #   prior(normal(0, 10), "b", coef="elev.z"),
  #   prior(normal(0, 10), "b", coef="elev.pos.z"),
  #   prior(normal(0, 10), "b", coef="mass.z"),
  #   prior(normal(0, 10), "b", coef="precip.z"),
  #   prior(normal(0, 10), "b", coef="temp.z"),
  #   prior(normal(0, 10), "b", coef="intravar.mass.z"),
  #   prior(normal(0, 10), "b", coef="intravar.precip.z"),
  #   prior(normal(0, 10), "b", coef="intravar.temp.z"),
  #   prior(normal(0, 10), "Intercept"),
  #   prior(student_t(0, 2.5), "sigma") # sigma = standard deviation
  #)
)
...
bayes_R2(trbc.m4) # 0.168
bayes_R2(trbc.m5) # 0.033
...
1) Model 4: Full model + (1|species) **significantly better than most models, marginally better than M6 (reduced), 21% variance explained by species, R^2 = 0.168
