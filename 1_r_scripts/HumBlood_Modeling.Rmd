...
date: "11/09/2020; Last Updated: 11/24/21"
output:
  md_document:
...
# HB - panel A
color_scheme_set("viridisD")
hb.m4.fig4a <- mcmc_plot(hb.m4, variable=c("b_elev.z", "b_elev.pos.z","b_mass.z","b_temp.z","b_precip.z",
...
# HCT - Panel B
color_scheme_set("viridisD")
hct.m4.fig4b <- mcmc_plot(hct.m4, variable=c("b_elev.z", "b_elev.pos.z","b_mass.z","b_temp.z","b_precip.z",
            "b_genotypeGlyMSer", "b_genotypeSerMSer","b_intravar.mass.z", "b_intravar.temp.z", "b_intravar.precip.z"),
            prob_outer=0.95, # 95% outer CI 
            prob=0.50, # 50% inner CI 
            point_est="mean") + # mean point est; default is median 
...
# TRBC - Panel C
color_scheme_set("viridisD")
trbc.m4.fig4c <- mcmc_plot(trbc.m4, variable=c("b_elev.z", "b_elev.pos.z","b_mass.z","b_temp.z","b_precip.z",
...
# MCV - panel D
color_scheme_set("viridisD")
mcv.m4.fig4d <- mcmc_plot(mcv.m4, variable=c("b_elev.z", "b_elev.pos.z","b_mass.z","b_temp.z","b_precip.z",
             "b_genotypeGlyMSer", "b_genotypeSerMSer", "b_intravar.mass.z","b_intravar.temp.z", "b_intravar.precip.z"),
             prob_outer=0.95, # 95% outer CI 
             prob=0.50, # 50% inner CI 
             point_est="mean") + # mean point est; default is median 
...
mcv.m6.fig4d.inset <- mcmc_plot(mcv.m6, variable=c("b_temp.z"),
                   prob_outer=0.95, # 95% outer CI
                   prob=0.50, # 50% inner CI
                   point_est="mean") + # mean point est; default is median
                   labs(x="Effect on MCV", title = " ") +
...
# MCH - panel E
color_scheme_set("viridisD")
mch.m4.fig4e <- mcmc_plot(mch.m4, variable=c("b_elev.z", "b_elev.pos.z","b_mass.z","b_temp.z","b_precip.z",
             "b_genotypeGlyMSer", "b_genotypeSerMSer", "b_intravar.mass","b_intravar.temp", "b_intravar.precip"),
             prob_outer=0.95, # 95% outer CI 
             prob=0.50, # 50% inner CI 
             point_est="mean") + # mean point est; default is median 
...
color_scheme_set("brightblue")
mch.m6.fig4e.inset <- mcmc_plot(mch.m6, variable=c("b_elev.z", "b_temp.z"),
                   prob_outer=0.95, # 95% outer CI
                   prob=0.50, # 50% inner CI
                   point_est="mean") + # mean point est; default is median
                   labs(x="Effect on MCH", title = " ") +
...
# MCHC - panel F
color_scheme_set("viridisD")
mchc.m4.fig4f <- mcmc_plot(mchc.m4, variable=c("b_elev.z", "b_elev.pos.z","b_mass.z","b_temp.z","b_precip.z",
              "b_genotypeGlyMSer", "b_genotypeSerMSer", "b_intravar.mass","b_intravar.temp", "b_intravar.precip"),
              prob_outer=0.95, # 95% outer CI 
              prob=0.50, # 50% inner CI 
              point_est="mean") + # mean point est; default is median 
...
# MCHC inset element 
color_scheme_set("brightblue")
mchc.m6.fig4f.inset <- mcmc_plot(mchc.m6, variable=c("b_intravar.mass.z", "b_intravar.temp.z"),
                    prob_outer=0.95, # 95% outer CI
                    prob=0.50, # 50% inner CI
                    point_est="mean") + # mean point est; default is median
                    labs(x="Effect on MCHC", title = "") +
