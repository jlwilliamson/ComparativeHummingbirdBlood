...
date: "3/29/2021; last revised 1/23/22"
...
This is necessary prior to further data wrangling because Patagona North and South are functionally separate species and could be modeled as such in our characterizations of species. Since their elevations and blood values may differ substantially (and thus, these values will affect outliers and distributions of other blood values), handle this now. 
```{r}
...
# IN DPLYR: MAKE SURE "SUMMARIZE" IS SPELLED WITH THE BRITISH 'SUMMMARISSSSSEE' OR IT WON'T WORK.
...
# data subsets. Prelim linear models reveal that they're highly influential. 
...
save(spm.hb.m1, file="spm.hb.m1_Intercept-Only.RData") # save model
#load("spm.hb.m1_Intercept-Only.Rdata") 
...
save(spm.hb.m2, file="spm.hb.m2_FullModel.RData") # save model
...
save(spm.hb.m3, file="spm.hb.m3_ReducedModel.RData") # save model
#load("spm.hb.m3_ReducedModel.RData") 
...
spm.hb.m3.unstandardized <- 
  update(spm.hb.m3,
        ...
        chains = 4, cores = 4)
save(spm.hb.m3.unstandardized, file="spm.hb.m3.unstandardized_Predictors_SpeciesRE.RData") # save model
})
#load("spm.hb.m3.unstandardized_Predictors_SpeciesRE.RData")
...
save(spm.hct.m1, file="spm.hct.m1_Intercept-Only.RData")
# load("spm.hct.m1_Intercept-Only.Rdata") 
...
save(spm.hct.m2, file="spm.hct.m2_FullModel.RData") 
...
save(spm.hct.m3, file="spm.hct.m3_ReducedModel.RData") # save model
#load("spm.hct.m3_ReducedModel.RData") # If loading from pre-saved file and not re-running
...
spm.hct.m2.unstandardized <- 
  update(spm.hct.m2,
        ...
        chains = 4, cores = 4)
save(spm.hct.m2.unstandardized, file="spm.hct.m2.unstandardized_Predictors.RData") # save model
})
#load("spm.hct.m2.unstandardized_Predictors.RData")
...
#   sample_prior = TRUE # save priors
# )
# save(spm.hct.m2.unstandardized, file="spm.hct.m2.unstandardized.RData") 
...
save(spm.trbc.m1, file="spm.trbc.m1_Intercept-Only.RData") # save model
# load("spm.trbc.m1_Intercept-Only.Rdata") 
...
save(spm.trbc.m2, file="spm.trbc.m2_FullModel.RData") # save model
# load("spm.trbc.m2_FullModel.RData") 
...
save(spm.trbc.m4, file="spm.trbc.m4_FullModelWithQuadratic.RData") # save model
#load("spm.trbc.m4_FullModelWithQuadratic.RData") # If loading from pre-saved file and not re-running
...
save(spm.trbc.m3, file="spm.trbc.m3_ReducedModel.RData") # save model
# load("spm.trbc.m3_ReducedModel.RData") 
...
#   sample_prior = TRUE # save priors 
# )
# save(spm.trbc.m5, file="spm.trbc.m5_ReducedModel.RData") # save model
# #load("spm.trbc.m5_ReducedModel.RData") 
})
```
...
save(spm.mcv.m1, file="spm.mcv.m1_Intercept-Only.RData") # save model
# load("spm.mcv.m1_Intercept-Only.RData") 
...
save(spm.mcv.m2, file="spm.mcv.m2_FullWithoutQuadratic.RData") # save model
# load("spm.mcv.m2_FullWithoutQuadratic.RData") # If loading from pre-saved file and not re-running
...
save(spm.mcv.m4, file="spm.mcv.m4_FullModelWithQuadratic.RData") # save model
#load("spm.mcv.m4_FullModelWithQuadratic.RData") # If loading from pre-saved file and not re-running
})
```
...
#   sample_prior = TRUE # save priors 
# )
# save(spm.mcv.m5, file="spm.mcv.m5_ReducedModel_PredictorsOnly.RData") # save model
# #load("spm.mcv.m5_ReducedModel_PredictorsOnly.RData") 
})
```
...
save(spm.mch.m1, file="spm.mch.m1_Intercept-Only.RData") # save model
# load("spm.mch.m1_Intercept-Only.RData") 
...
save(spm.mch.m2, file="spm.mch.m2_FullWithoutQuadratic.RData") # save model
# load("spm.mch.m2_FullWithoutQuadratic.RData") # If loading from pre-saved file and not re-running
...
save(spm.mch.m4, file="spm.mch.m4_FullModelWithQuadratic.RData") # save model
...
save(spm.mch.m5, file="spm.mch.m5_ReducedModel_PredictorsOnly.RData") # save model
load("spm.mch.m5_ReducedModel_PredictorsOnly.RData") # If loading from pre-saved file and not re-running
})
```
...
spm.mch.m5.unstandardized <- 
  update(spm.mch.m5,
        ...
        chains = 4, cores = 4)
save(spm.mch.m5.unstandardized, file="spm.mch.m5.unstandardized.RData") # save model
})
#load("spm.mch.m5.unstandardized.RData")
...
save(spm.mchc.m1, file="spm.mchc.m1_Intercept-Only.RData") # save model
# load("spm.mchc.m1_Intercept-Only.Rdata") 
...
save(spm.mchc.m2, file="spm.mchc.m2_FullModel.RData") # save model
# load("spm.mchc.m2_FullModel.RData") 
...
save(spm.mchc.m4, file="spm.mchc.m4_FullModelWithQuadratic.RData") # save model
...
#   sample_prior = TRUE # save priors 
# )
# save(spm.mchc.m3, file="spm.mchc.m3_ReducedModel.RData") # save model
# #load("spm.mchc.m3_ReducedModel.RData") # If loading from pre-saved file and not re-running
# 
# 
# # MODEL 5: REDUCED MODEL
# spm.mchc.m5 <- brm(
...
#   sample_prior = TRUE # save priors 
# )
# save(spm.mchc.m5, file="spm.mchc.m5_ReducedModel.RData") # save model
# #load("spm.mchc.m5_ReducedModel.RData") 
# })
```
...
load("spm.hb.m2_FullModel.RData")  # full 
load("spm.hb.m4_ReducedModel.RData") # top; tied with full model 

load("spm.hct.m2_FullModel.RData") # full
#load("spm.hct.m4_ReducedModel.RData") # top model (elev)

load("spm.trbc.m2_FullModel.RData") # full 
# TRBC null is top 

load("spm.mcv.m3_FullModelWithQuadratic.RData") # full w/ quad 
# MCV null is top 

load("spm.mch.m3_FullModelWithQuadratic.RData") # full w/ quadratic 
load("spm.mch.m5_ReducedModel_PredictorsOnly.RData") # top model 

load("spm.mchc.m3_FullModelWithQuadratic.RData") # full 
