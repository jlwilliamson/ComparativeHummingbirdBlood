...
date: "12/1/2020; last revised 1/23/22"
...
VERSION 1 OF THIS MAP IS THE FINAL VERSION INCLUDED IN OUR PAPER FIGURE 1! 
```{r}
...
# MAP VERSION 4: all of South America, no cropping, non-Chile, non-Peru countries faded 
```{r}
# Peru and Chile sampling localities w/ rest of South America 
...
# COQUETTES 
# I specifically use weird decimals becuase it was the easiest way I could think of to keep necessary order
...
This produces the raw phylo-ordered elev ranges for each species, with gray points representing sampling of single individuals along the gradient, adn red diamonds representing species elevational midpoints. 
```{r}
#sort by phylo_order
