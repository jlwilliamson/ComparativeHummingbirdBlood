...
pdat <- read.csv(here::here("./Patagona_subset_cleaned_for_merge_with_AllHummingbirdComparative_11-30-20.csv"))  
...
full <- full[-which(full$mcv < 50 | test$mcv > 150),] # 29 observations 
...
# write.csv(final, "/Users/Jessie/Dropbox (MSBbirds)/Rdirectory/ComparativeHummingbirdBlood/AllHummingbirdBlood_Wrangled_withBioClim_11-30-20.csv")
```
...
write.csv(final, "/Users/Jessie/Dropbox (MSBbirds)/Rdirectory/ComparativeHummingbirdBlood/AllHummingbirdBlood_Wrangled_withBioClim_andPCA_12-01-20.csv")
...
write.csv(final.nopgig, "/Users/Jessie/Dropbox (MSBbirds)/Rdirectory/ComparativeHummingbirdBlood/HumBlood.final.nopgig_12-01-20.csv")
```
