...
date: "4/26/2021; last revised 1/17/22"
...
Followed these instructions to set up SSH key with happygitfromR but if they don't work see this: https://happygitwithr.com/ssh-keys.html
...
This will be Figure S2 in paper. May want to move this to plots and figs script but leaving here now while I'm figuring stuff out. 
```{r}
