...
date: "4/26/2021; last revised 7/28/21"
...
- Model 2, full model + species grouping variable fits best by var! Variance explained by species: 8%. R^2 = 0.85. 
...
# FIGURE S3: Species-specific Conditional effects plots 
This will be Figure S3 in paper. May want to move this to plots and figs script but leaving here now while I'm figuring stuff out. 
```{r}
...
cens.Hmic.p1 <- mcmc_plot(cens.Hmic, pars=c("b_mcv.z", "b_trbc.z"),
                                    ...
                                    prob=0.50, # 50% inner CI 
                                    point_est="mean") + # mean point est; default is median 
labs(x="", title = "H. micrastur") +
ggtitle(expression(paste(bold("P"),~~~~italic("H. micrastur")))) + 
        theme(plot.title.position = "plot", # "plot" = you want "title" flush with y-axis
        plot.title = element_text(face="bold")) +
scale_y_discrete(labels=c("","")) +
            theme(plot.title = element_text(family = "Helvetica", color="black",size=9)) + # font = panel header size
...
ggsave(FigS3_PosteriorProbs, filename = "FigS3_CeNS_Species-Specific_PosteriorProbs_06-10-21.pdf", bg="transparent", height=7, width=12, units="in")
```
