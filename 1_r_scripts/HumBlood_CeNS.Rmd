...
FigS3_PosteriorProbs <- (cens.Amel.p1 + cens.Acas.p1 + cens.Akin.p1 + cens.Aama.p1 + cens.Clar.p1 + cens.Coen.p1 + 
...
plot(FigS3_PosteriorProbs)
ggsave(FigS3_PosteriorProbs, filename = "FigS3_CeNS_Species-Specific_PosteriorProbs_2022-01-18.pdf", bg="transparent", height=7, width=12, units="in")
```
...
pdf(file="CeNS.index.contmap_06-10-21.pdf", width=6, height=6) # Write plot to pdf 
