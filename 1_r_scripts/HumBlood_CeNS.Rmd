...
date: "4/26/2021; last revised 6/10/21"
...
final <- read.csv("ComparativeHummingbirdBlood_FinalDataset_ForModeling_06-10-21.csv", stringsAsFactors = FALSE)
...
```{r}
# cens.ss.mean <- read.csv("cens.ss.mean_ForCeNSmodeling_06-03-21.csv", stringsAsFactors = FALSE)
```
...
***consider moving this into plots and figs script once things are settled! 
```{r}
