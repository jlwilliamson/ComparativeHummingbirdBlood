...
date: "7/21/2020; last revised 01/22/22"
output:
  md_document:
...
# FIGURE 4 (3-panels, banana plots + CeNS): CELL NUMBER-SIZE TRADEOFF + CENS RESULTS
...
# color_scheme_set("viridisC") # Used viridisD for other posterior prob plots (figure 4)
# #color_scheme_set("brightblue")
# fig4d_inset <- mcmc_plot(cens.m5, variable=c("b_mass.z", "b_elev.z", "b_Ielev.zE2"),
#                prob_outer=0.95, # 95% outer CI
#                prob=0.89, # 50% inner CI
#                point_est="mean", # mean point est; default is median
...
#                #theme(plot.margin = unit(c(0.2,0.1,0.0,0.2), "cm")) +  # top, right, bottom, left
# fig4d_inset
# ggsave(fig4d_inset, filename = "fig4d_inset_PosteriorEstimates&CredibleIntervals.pdf", bg="transparent", height=7, width=9, units="in")
...
# FIGURE S1: In CeNS script. Sigle-species posterior probability plots. 
...
# FIGURE S4: in CeNS script, contmap showing CeNS across the phylogeny
